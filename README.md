...
| Linux Essentials (LPIC-1) | Linux Professional Institute |
| ITIL 4 Foundation | Axelos |
| Certified Kubernetes Administrator (CKA) | _In Progress_ |
| Azure DevOps Expert (AZ-400) | _In Progress_ |
...
|---------|-------------|-------|
| [DevSecOps-app-Project](https://github.com/SirADarbi/DevSecOps-app-Project) | GitOps workflow with shift-left security scanning (Snyk, Trivy, SonarQube) for automated zero-downtime deployments on AWS EKS | Terraform, ArgoCD, GitHub Actions, EKS |
| [DevSecOps-IAC-Project](https://github.com/SirADarbi/DevSecOps-IAC-Project) | Infrastructure as Code companion -- EKS provisioning with ALB Ingress, Route 53, plus Prometheus & Grafana observability | Terraform, AWS, HCL |
| *More coming soon...* | | |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/sirajdarbi/)
[![GitHub](https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/SirADarbi)
